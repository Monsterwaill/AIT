...
public class BasicBoxModel extends TARDISExteriorModelSchema {
    ...
    public BasicBoxModel() {
        ...
        this.setRotationAngle(Wall_r1, 0.0F, 3.1416F, 0.0F);
        ...
        this.setRotationAngle(Wall_r2, 0.0F, 1.5708F, 0.0F);
        ...
        this.setRotationAngle(cube_r4, 0.0F, 0.7854F, 0.0F);
        ...
        this.setRotationAngle(cube_r5, 0.0F, 1.5708F, 0.0F);
        ...
        this.setRotationAngle(cube_r7, 0.0F, -1.5708F, 0.0F);
        ...
        this.setRotationAngle(cube_r9, 1.0472F, 0.0F, 0.0F);
        ...
        this.setRotationAngle(cube_r11, 0.0F, 0.0F, 0.6109F);
        ...
        this.setRotationAngle(cube_r12, 0.0F, 0.0F, -0.6109F);
        ...
        this.setRotationAngle(cube_r13, 0.0F, 0.0F, -1.0472F);
        ...
        this.setRotationAngle(cube_r14, -1.0472F, 0.0F, 0.0F);
        ...
        this.setRotationAngle(cube_r15, -0.6109F, 0.0F, 0.0F);
