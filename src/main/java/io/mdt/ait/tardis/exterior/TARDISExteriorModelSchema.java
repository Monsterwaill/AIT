...
public abstract class TARDISExteriorModelSchema extends EntityModel {
    ...
    /**
     * @deprecated DO NOT USE THIS METHOD. For conveniece, override {@link #render(TARDISTileEntity, MatrixStack, IVertexBuilder, int, int, float, float, float, float)} method instead!
     */
    @Override
    @Deprecated
    public void renderToBuffer(MatrixStack stack, IVertexBuilder builder, int light, int overlay, float r, float g, float b, float a) {
        throw new IllegalArgumentException("Do not use this method. Check the deprecation notice and update your code accordingly.");
    }
}
