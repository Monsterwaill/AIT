...
public class AITClientRegistry {
    public static final EnumMap<EnumExteriorType, Supplier<EntityModel<Entity>>> TARDIS_EXTERIOR_MAP =
            new EnumMap<>(EnumExteriorType.class);
    public static final EnumMap<EnumConsoleType, Supplier<EntityModel<Entity>>> TARDIS_CONSOLE_MAP =
            new EnumMap<>(EnumConsoleType.class);
    public static final EnumMap<EnumInteriorDoorType, Supplier<EntityModel<Entity>>> TARDIS_DOOR_MAP =
            new EnumMap<>(EnumInteriorDoorType.class);

    // Phone Booths :D
    public static final EnumMap<EnumPhoneBoothType, Supplier<EntityModel<Entity>>> PHONE_BOOTH_MAP =
            new EnumMap<>(EnumPhoneBoothType.class);
    ...
    public static void register(FMLClientSetupEvent event) {
        ...
        ClientRegistry.bindTileEntityRenderer(AITTiles.TARDIS_TILE_ENTITY_TYPE.get(), TARDISRenderer::new);
        ...
        ClientRegistry.bindTileEntityRenderer(
                AITTiles.BASIC_INTERIOR_DOOR_TILE_ENTITY_TYPE.get(), BasicInteriorDoorRenderer::new);
        ...
        ClientRegistry.bindTileEntityRenderer(
                AITTiles.TOYOTA_WHIRLAGIG_TILE_ENTITY_TYPE.get(), ToyotaWhirlagigRenderer::new);
        ClientRegistry.bindTileEntityRenderer(AITTiles.TOYOTA_ROTOR_TILE_ENTITY_TYPE.get(), ToyotaRotorRenderer::new);
        ClientRegistry.bindTileEntityRenderer(
                AITTiles.DIMENSION_SWITCH_CONTROL_TILE_ENTITY_TYPE.get(), DimensionSwitchControlRenderer::new);
        ClientRegistry.bindTileEntityRenderer(
                AITTiles.TARDIS_COORDINATE_CONTROL_TILE_ENTITY_TYPE.get(), TardisCoordinateControlRenderer::new);
        ClientRegistry.bindTileEntityRenderer(
                AITTiles.EXTERIOR_FACING_CONTROL_TILE_ENTITY_TYPE.get(), ExteriorFacingControlRenderer::new);
        ClientRegistry.bindTileEntityRenderer(
                AITTiles.HARTNELL_ROTOR_TILE_ENTITY_TYPE.get(), HartnellRotorRenderer::new);
        ClientRegistry.bindTileEntityRenderer(
                AITTiles.TENNANT_MONITOR_TILE_ENTITY_TYPE.get(), TennantMonitorRenderer::new);
        ClientRegistry.bindTileEntityRenderer(
                AITTiles.TOYOTA_MONITOR_TILE_ENTITY_TYPE.get(), ToyotaMonitorRenderer::new);
        ClientRegistry.bindTileEntityRenderer(
                AITTiles.TARDIS_POWER_ACCESS_POINT_TILE_ENTITY_TYPE.get(), TardisPowerAccessPointRenderer::new);
        ClientRegistry.bindTileEntityRenderer(
                AITTiles.DOOR_SWITCH_CONTROL_TILE_ENTITY_TYPE.get(), DoorSwitchControlRenderer::new);
         ...
         * TARDIS_EXTERIOR_MAP.put(EnumExteriorType.TYPE_40_TT_CAPSULE,
         * Type40TTCapsuleExterior::new);
         * TARDIS_EXTERIOR_MAP.put(EnumExteriorType.HELLBENT_TT_CAPSULE,
         * HellBentTTCapsuleExterior::new);
         ...
         * TARDIS_EXTERIOR_MAP.put(EnumExteriorType.FALLOUT_SHELTER_EXTERIOR,
         * FalloutShelterExterior::new); TARDIS_EXTERIOR_MAP.put(EnumExteriorType.CLOCK_EXTERIOR,
         * ClockExterior::new);
         */
        ...
        // TARDIS_DOOR_MAP.put(EnumInteriorDoorType.DOOR_TYPE_40_TT_CAPSULE,
        // Type40TTCapsuleExterior::new);
        // TARDIS_DOOR_MAP.put(EnumInteriorDoorType.DOOR_HELLBENT_TT_CAPSULE,
        // HellBentTTCapsuleExterior::new);
        ...
        // TARDIS_DOOR_MAP.put(EnumInteriorDoorType.DOOR_ARCADE_CABINET_EXTERIOR,
        // ArcadeCabinet::new);
        ...
        // TARDIS_DOOR_MAP.put(EnumInteriorDoorType.DOOR_FALLOUT_SHELTER_EXTERIOR,
        // FalloutShelterExterior::new);
        ...
        RenderingRegistry.registerEntityRenderingHandler(
                AITEntities.CLASSIC_DALEK_ENTITY.get(), ClassicDalekEntityRenderer::new);
        RenderingRegistry.registerEntityRenderingHandler(
                AITEntities.LASER_SHOT_ENTITY.get(), LaserShotEntityRenderer::new);

        // CONTROL ENTITIES
        RenderingRegistry.registerEntityRenderingHandler(
                AITEntities.THROTTLE_INTERACTION_ENTITY.get(), ControlInteractionEntityRenderer::new);
        RenderingRegistry.registerEntityRenderingHandler(
                AITEntities.COORDX_INTERACTION_ENTITY.get(), ControlInteractionEntityRenderer::new);
        RenderingRegistry.registerEntityRenderingHandler(
                AITEntities.COORDY_INTERACTION_ENTITY.get(), ControlInteractionEntityRenderer::new);
        RenderingRegistry.registerEntityRenderingHandler(
                AITEntities.COORDZ_INTERACTION_ENTITY.get(), ControlInteractionEntityRenderer::new);
        RenderingRegistry.registerEntityRenderingHandler(
                AITEntities.INCREMENT_INTERACTION_ENTITY.get(), ControlInteractionEntityRenderer::new);
        RenderingRegistry.registerEntityRenderingHandler(
                AITEntities.DIMENSIONAL_CONTROL_INTERACTION_ENTITY.get(), ControlInteractionEntityRenderer::new);
        RenderingRegistry.registerEntityRenderingHandler(
                AITEntities.POSITIVE_NEGATIVE_INTERACTION_ENTITY.get(), ControlInteractionEntityRenderer::new);
        RenderingRegistry.registerEntityRenderingHandler(
                AITEntities.EXTERIOR_FACING_INTERACTION_ENTITY.get(), ControlInteractionEntityRenderer::new);
        RenderingRegistry.registerEntityRenderingHandler(
                AITEntities.MONITOR_INTERACTION_ENTITY.get(), ControlInteractionEntityRenderer::new);

        // Falling TARDIS
        RenderingRegistry.registerEntityRenderingHandler(
                AITEntities.FALLING_TARDIS_ENTITY.get(), FallingTardisRenderer::new);
        // RenderingRegistry.registerEntityRenderingHandler(AITEntities.CUSTOM_PORTAL_ENTITY.get(),
        // CustomPortalRenderer::new);
