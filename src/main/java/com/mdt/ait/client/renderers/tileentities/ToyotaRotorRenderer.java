...
public class ToyotaRotorRenderer extends TileEntityRenderer<ToyotaRotorTile> {
    ...
    public static final ResourceLocation LOCATION =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/block_rotors/toyota_rotor.png");
    public static final ResourceLocation LIGHTING =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/block_rotors/toyota_rotor_emission.png");
    ...
    public void render(
        ...
        MatrixStackIn.mulPose(Vector3f.YP.rotationDegrees(
                tile.getBlockState().getValue(ToyotaRotorBlock.FACING).toYRot()));
        MatrixStackIn.pushPose();
        // if(tile.isInFlight) {
        MatrixStackIn.translate(0, tile.rotorTick / 1.25, 0);
        // }
        model.toppipe.render(
                MatrixStackIn,
