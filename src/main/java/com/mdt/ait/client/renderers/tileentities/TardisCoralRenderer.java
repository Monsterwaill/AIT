...
public class TardisCoralRenderer extends TileEntityRenderer<TardisCoralTile> {
    ...
    public static final ResourceLocation STATE1 =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/tardis_coral/tardis_coral_1.png");
    public static final ResourceLocation STATE2 =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/tardis_coral/tardis_coral_2.png");
    public static final ResourceLocation STATE3 =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/tardis_coral/tardis_coral_3.png");
    public static final ResourceLocation STATE4 =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/tardis_coral/tardis_coral_4.png");
    public static final ResourceLocation STATE5 =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/tardis_coral/tardis_coral_5.png");
    public static final ResourceLocation STATE_FINAL =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/tardis_coral/tardis_coral_final.png");
    ...
    public void render(
        ...
        MatrixStackIn.mulPose(Vector3f.YP.rotationDegrees(
                tile.getBlockState().getValue(TardisCoralBlock.FACING).toYRot()));
        MatrixStackIn.mulPose(Vector3f.YN.rotationDegrees(180.0f));
        model.render(
                tile,
                MatrixStackIn,
                Buffer.getBuffer(AITRenderTypes.tardisRenderOver(coralStateLocation)),
                CombinedLight,
                CombinedOverlay,
                1,
                1,
