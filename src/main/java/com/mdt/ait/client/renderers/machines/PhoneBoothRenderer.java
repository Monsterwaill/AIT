...
public class PhoneBoothRenderer extends TileEntityRenderer<PhoneBoothTile> {
    ...
    public static final ResourceLocation LOCATION =
            new ResourceLocation(AIT.MOD_ID, "textures/exteriors/phone_booth.png");
    public static final ResourceLocation LM_LOCATION =
            new ResourceLocation(AIT.MOD_ID, "textures/exteriors/phone_booth_emission.png");
    ...
    public void render(
        ...
        MatrixStackIn.mulPose(Vector3f.YP.rotationDegrees(tile.getBlockState()
                .getValue(PhoneBoothBlock.FACING)
                .getOpposite()
                .toYRot()));
