...
public class GBTCasingRenderer extends TileEntityRenderer<GBTCasingTile> {
    ...
    public static final ResourceLocation LOCATION =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/gallifreyan_block_transfer_casing.png");
    ...
    public void render(
        ...
        MatrixStackIn.mulPose(Vector3f.YP.rotationDegrees(
                tile.getBlockState().getValue(GBTCasingBlock.FACING).toYRot()));
        IVertexBuilder vertexBuffer = Buffer.getBuffer(RenderType.entityTranslucent(LOCATION));
