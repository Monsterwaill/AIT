...
import net.minecraft.client.model.IRenderTypeBuffer;
import net.minecraft.client.model.RenderType;
import net.minecraft.client.model.entity.EntityRendererManager;
import net.minecraft.client.model.entity.FallingBlockRenderer;
import net.minecraft.client.model.tileentity.TileEntityRenderer;
import net.minecraft.client.model.tileentity.TileEntityRendererDispatcher;
