...
public class RecordPlayerRenderer extends TileEntityRenderer<RecordPlayerTile> {
    ...
    public static final ResourceLocation ORIGINAL =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/record_player.png");
    public static final ResourceLocation THIRTEEN_RECORD =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/record_player_13.png");
    public static final ResourceLocation CAT_RECORD =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/record_player_cat.png");
    public static final ResourceLocation BLOCKS_RECORD =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/record_player_blocks.png");
    public static final ResourceLocation CHIRP_RECORD =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/record_player_chirp.png");
    public static final ResourceLocation FAR_RECORD =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/record_player_far.png");
    public static final ResourceLocation MALL_RECORD =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/record_player_mall.png");
    public static final ResourceLocation MELLOHI_RECORD =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/record_player_mellohi.png");
    public static final ResourceLocation STAL_RECORD =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/record_player_stal.png");
    public static final ResourceLocation STRAD_RECORD =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/record_player_strad.png");
    public static final ResourceLocation WARD_RECORD =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/record_player_ward.png");
    public static final ResourceLocation ELEVEN_RECORD =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/record_player_11.png");
    public static final ResourceLocation WAIT_RECORD =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/record_player_wait.png");
    public static final ResourceLocation PIGSTEP_RECORD =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/record_player_pigstep.png");
    ...
    public void render(
        ...
        matrixStack.mulPose(Vector3f.YP.rotationDegrees(
                tile.getBlockState().getValue(RecordPlayerBlock.FACING).toYRot()));
