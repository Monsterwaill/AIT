...
public class DoorSwitchControlRenderer extends TileEntityRenderer<DoorSwitchControlTile> {
    ...
    public static final ResourceLocation LOCATION =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/controls/door_switch.png");
    ...
    public void render(
        ...
        MatrixStackIn.mulPose(Vector3f.YP.rotationDegrees(
                tile.getBlockState().getValue(DoorSwitchControlBlock.FACING).toYRot()));
        model.render(
                tile,
                MatrixStackIn,
