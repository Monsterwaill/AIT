...
public class TARDISKey extends Item {
    ...
    public ActionResultType useOn(ItemUseContext context) {
        ...
        if (block instanceof TARDISBlock) {
            ...
            if (tileEntity instanceof TARDISTileEntity) {
                // ((TARDISTileEntity) tileEntity).keyUsedOnTardis(context, blockpos, blockstate,
                // block); fixme
            }
        }
        ...
        if (block instanceof TARDISBlock) {
            ...
            /*
             * if(tardisTileEntity.tard != null) { tag.putUUID("tardisIdentification",
             * tardisTileEntity.linkedTardisId); } tag.putString("greekCharacters",
    ...
    public void appendHoverText(
        ...
        /*
         * if(TARDISKey.getTardisId(stack).needsInitialization()) { tooltip.add(new
         * TranslationTextComponent("Key ID: " + TARDISKey.getGreekCharacters(stack))
         * .setStyle(Style.EMPTY.withItalic(true).withColor(TextFormatting.AQUA))); tooltip.add(new
         * TranslationTextComponent("Linked TARDIS: " + TARDISKey.getTardisId(stack))
         * .setStyle(Style.EMPTY.withItalic(true).withColor(TextFormatting.DARK_AQUA))); } else {
         * tooltip.add(new TranslationTextComponent("Link to TARDIS via the exterior!")
         * .setStyle(Style.EMPTY.withItalic(true).withColor(TextFormatting.AQUA))); // i tricked
         * you! // you got me mzsty - Duzo }
         */
    }
}
