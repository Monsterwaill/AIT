...
public class HartnellRotorRenderer extends TileEntityRenderer<HartnellRotorTile> {
    ...
    public static final ResourceLocation LOCATION =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/hartnell_rotor.png");
    public static final ResourceLocation LIGHTING_1 =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/hartnell_rotor_emission_one.png");
    public static final ResourceLocation LIGHTING_2 =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/hartnell_rotor_emission_two.png");
    ...
    public void render(
        ...
        MatrixStackIn.mulPose(Vector3f.YP.rotationDegrees(
                tile.getBlockState().getValue(HartnellRotorBlock.FACING).toYRot()));
        MatrixStackIn.pushPose();
        // if(tile.isInFlight) {
        ...
        model.rotor.render(
                MatrixStackIn,
                Buffer.getBuffer(AITRenderTypes.tardisLightmap(lightingTexture, false)),
                CombinedLight,
                CombinedOverlay,
                1,
                1,
