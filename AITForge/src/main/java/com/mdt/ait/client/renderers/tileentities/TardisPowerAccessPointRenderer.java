...
public class TardisPowerAccessPointRenderer extends TileEntityRenderer<TardisPowerAccessPointTile> {
    ...
    public static final ResourceLocation LOCATION =
            new ResourceLocation(AIT.MOD_ID, "textures/tileentities/tardis_power_access_point.png");
    ...
    @Override
    public void render(
            TardisPowerAccessPointTile tile,
            float PartialTicks,
        ...
        MatrixStackIn.mulPose(Vector3f.YP.rotationDegrees(tile.getBlockState()
                .getValue(TardisPowerAccessPointBlock.FACING)
                .toYRot()));
