...
public class BasicConsoleRenderer extends TileEntityRenderer<ConsoleTileEntity> {
    ...
    public static final ResourceLocation LOCATION =
            new ResourceLocation(AIT.MOD_ID, "textures/consoles/dev_console.png");
    public static final ResourceLocation TEST_LOCATION =
            new ResourceLocation(AIT.MOD_ID, "textures/exteriors/mint_tardis_exterior.png");
    public static final ResourceLocation BOREALIS_LOCATION =
            new ResourceLocation(AIT.MOD_ID, "textures/consoles/borealis_console.png");
    public static final ResourceLocation HUDOLIN_LOCATION =
            new ResourceLocation(AIT.MOD_ID, "textures/consoles/hudolin_console.png");

    public static final ResourceLocation LM_HUDOLIN =
            new ResourceLocation(AIT.MOD_ID, "textures/consoles/hudolin_console_emission.png");

    // public static final ResourceLocation BOREALIS_LM_LOCATION = new ResourceLocation(AIT.MOD_ID,
    // "textures/consoles/borealis_console_emission.png");
    ...
    public void render(
        ...
        if (console.getSerializedName().equals("borealis_console") && consoletype == 0) {
            ...
            MatrixStackIn.mulPose(Vector3f.YP.rotationDegrees(
                    tile.getBlockState().getValue(ConsoleBlock.FACING).toYRot()));
            if (tile.throttleHit()) {
                ((BorealisConsole) this.model).handbrake.xRot = -75f;
            } else {
                ((BorealisConsole) this.model).handbrake.xRot = 150f;
            }
            // model.render(tile, MatrixStackIn,
            // Buffer.getBuffer(AITRenderTypes.tardisLightmap(BOREALIS_LM_LOCATION, true)),
        ...
        if (console.getSerializedName().equals("hudolin_console") && consoletype == 1) {
            ...
            model.render(
                    tile,
                    MatrixStackIn,
                    Buffer.getBuffer(AITRenderTypes.tardisLightmap(LM_HUDOLIN, true)),
                    CombinedLight,
                    CombinedOverlay,
                    1,
                    1,
        ...
        model.render(
                tile,
                MatrixStackIn,
                Buffer.getBuffer(RenderType.entityCutout(this.texture)),
                CombinedLight,
                CombinedOverlay,
                1,
                1,
