...
public class AITRenderTypes extends RenderType {
    ...
    protected static final RenderState.TransparencyState GENERIC = new RenderState.TransparencyState(
            "generic",
            () -> {
    ...
    protected static final RenderState.DiffuseLightingState DIFFUSE_LIGHTING_ENABLED =
            new RenderState.DiffuseLightingState(true);

    public AITRenderTypes(
            String p_i225992_1_,
